...
namespace LinguaBender.Views
{
    public partial class CoursesAddWindow : Window
    {
        ...
        public CoursesAddWindow(ICourseService courseService)
        {
            InitializeComponent();
        ...
        public async void SaveCourse(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Новый курс успешно добавлен!");
                this.Close();
            }
            catch (Exception ex)
            {
